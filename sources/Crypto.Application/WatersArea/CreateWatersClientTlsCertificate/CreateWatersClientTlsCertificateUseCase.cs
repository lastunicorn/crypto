...
internal class CreateWatersClientTlsCertificateUseCase : IRequestHandler<CreateWatersClientTlsCertificateRequest, CreateWatersClientTlsCertificateResponse>
{
    private readonly ILog log;
    private readonly ICertificateRepository certificateRepository;
    private readonly IUserInterface userInterface;

    public CreateWatersClientTlsCertificateUseCase(ILog log, ICertificateRepository certificateRepository, IUserInterface userInterface)
    {
    ...
    public Task<CreateWatersClientTlsCertificateResponse> Handle(CreateWatersClientTlsCertificateRequest request, CancellationToken cancellationToken)
    {
        ...
        CreateWatersClientTlsCertificateResponse response = new CreateWatersClientTlsCertificateResponse();
